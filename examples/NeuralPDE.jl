...
u_predict_vec = u_predict |> vec

gl_points = GLMakie.Point.(xs_vec,ys_vec,u_predict_vec) |> vec
...
wireframe!(ax, gb_mesh, color=(:black, 0.2), linewidth=2, transparency=true)  # only for the asthetic -> has no practical function
